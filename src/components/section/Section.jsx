...
const Section = () => {
    ...
    return (
        ...
        <Header  />
        <div className="w-full bg-[#FEEEDE] flex justify-center 4xl:items-center adaptiv_section overflow-hidden h-[80vh] lg:h-[50vh] xl:h-[60vh] 2xl:h-[70vh] 4xl:h-[70vh] 3xl:h-[81vh]  5xl:h-[90vh] pt-[10px] pb-[1vw] top-[80px]">
            <div className="relative containers flex items-center flex-col gap-10">
                <img style={{maxWidth:"65%", maxHeight:'65%'}} src={lili} className="relative z-50  mr-[30px]" alt="Lili png" />
