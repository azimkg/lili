...
const Section = () => {
    ...
    return (
        ...
        <Header  />
        <div className="w-full bg-[#FEEEDE] flex justify-center 4xl:items-center adaptiv_section overflow-hidden h-[80vh] 2xl:h-[73vh] 4xl:h-[80vh] 3xl:h-[81vh]  5xl:h-[90vh] pt-[10px] pb-[2vw] top-[80px]">
