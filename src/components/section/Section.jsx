...
const Section = () => {
    ...
    return (
        ...
        <Header  />
        <div className="w-full bg-[#FEEEDE] flex justify-center 4xl:items-center adaptiv_section overflow-hidde h-[80vh] lg:h-[45vh] xl:h-[55vh] 2xl:h-[60vh] 4xl:h-[65vh] 3xl:h-[75vh]  5xl:h-[90vh] pt-[10px] pb-[3vw] top-[80px]">
