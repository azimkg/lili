...
const FreeMint = () => {
    ...
    return (
        <div className="flex flex-col items-center">
            <h2 style={{ lineHeight: '82px' }} className="text-white uppercase text-4xl sm:text-[70px] md:text-[110px] md:-tracking-[4px] text-center">WELCOME</h2>
            ...
            <Button className={'w-[350px] h-[60px] sm:w-[536px] sm:h-[94px] mb-10'} onClick={saveWallet}>MINT FOR FREE</Button>
        </div>
    );
};
