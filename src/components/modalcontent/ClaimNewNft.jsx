...
const ClaimNewNft = () => {
    ...
    return (
        <div className="flex flex-col items-center">
            <h2 className="text-white uppercase text-4xl md:text-[60px] md:-tracking-[0px] text-center linHeight">WELCOME</h2>
            <p className="font-dang text-xl md:text-[31px] text-white text-center -tracking-[1px] mt-2">You hold 0 old NFTs</p>
            <div className="w-full flex flex-col items-start">
                <p className="font-dang text-[20px] text-white text-center -tracking-[1px] mt-3">Ethereum Wallet</p>
            ...
            <div className="w-full flex flex-col items-start">
                <p className="font-dang text-[20px] text-white text-center -tracking-[1px] mt-3">Solana Wallet</p>
                <div className="bg-[#FD62A6] rounded-[45px] px-5 py-3 w-full">
            ...
            <Button onClick={saveWallet} className={'w-[350px] h-[60px] sm:w-[536px] sm:h-[74px] mt-6'}>CLAIM NEW NFTs</Button>
        </div>
    );
};
